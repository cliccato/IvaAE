...
class Iva:
    def __init__(self, taxation, device_number) -> None:
        self.taxation = taxation
        self.device_number = device_number

    def get_data(self):
        url = f"https://ivaservizi.agenziaentrate.gov.it/ser/mobile/fiscalizzazione/v1/stato/{self.taxation}?seed={self.device_number}"
        regex="[a-zA-Z0-9 ]+: "
        info=[]
